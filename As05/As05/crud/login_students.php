...
if ( !empty($_POST)) { // if $_POST filled then process the form
	...
	if($data) { // if successful login set session variables
		...
		$_SESSION['tutor_id'] = null;
		$sessionid = $data['id'];
		//$_SESSION['student_title'] = $data['title'];
		Database::disconnect();
		...
		Database::disconnect();
		header("Location: login_stud_error.html");
	}
} 
...
<body>
    <div class="container">
		...
		<div class="span10 offset1">
			...
			<form class="form-horizontal" action="login_students.php" method="post">
				...
				<div class="form-actions">
					...
					&nbsp; &nbsp;
					<a class="btn btn-primary" href="create_students.php">Join (New Student)</a>
				</div>
